...
export class AddFulfilledAtToOrderManually1747183941563 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        console.log('Skipping ADD COLUMN "fulfilledAt" to "orders" as it already exists. Marking migration as run.');
    }
