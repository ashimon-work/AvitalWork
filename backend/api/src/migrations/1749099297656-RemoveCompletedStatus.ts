...
export class RemoveCompletedStatus1749099297656 implements MigrationInterface {
    name = 'RemoveCompletedStatus1749099297656'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum_old" AS ENUM('pending', 'processing', 'shipped', 'delivered', 'completed', 'cancelled', 'failed')`);
        await queryRunner.query(`ALTER TABLE "orders" ALTER COLUMN "status" DROP DEFAULT`);
