...
export class CreateTranzilaEntities1748123358897 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tranzila_documents" DROP CONSTRAINT IF EXISTS "FK_c097f4cbf0e6e1b76ce0469e41c"`);
        await queryRunner.query(`ALTER TABLE "credit_cards" DROP CONSTRAINT IF EXISTS "FK_316ec479135fbc369ccf229dd0f"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_1582a04e0ded58964cdac1b4bb"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_9d87487d16d04ff695ae0ddac9"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_253599a7deab789abbadbf3765"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "tranzila_documents"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_316ec479135fbc369ccf229dd0"`);
