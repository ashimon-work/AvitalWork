...
export class PaymentMethodsController {
  ...
  @Get()
  @ApiOperation({
    summary: "Get all user's payment methods for the current store",
  })
  @ApiResponse({
    status: 200,
  ...
  @Get(':methodId')
  @ApiOperation({
    summary: 'Get a specific payment method by ID for the current store',
  })
  @ApiParam({
    name: 'methodId',
  ...
  async findOneForUser(
    ...
    return this.paymentMethodsService.findOneForUser(
      userId,
      storeSlug,
      methodId,
    );
  ...
  @ApiOperation({
    summary: 'Add a new payment method for the user in the current store',
  })
  ...
  @ApiResponse({
    status: 400,
    description: 'Invalid input or missing store context.',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized.' })
  async createForUser(
    @Req() req: AuthenticatedRequest,
    ...
    return this.paymentMethodsService.createForUser(
      userId,
      storeSlug,
  ...
  @ApiOperation({
    summary:
      'Update an existing payment method for the user in the current store',
  })
  @ApiParam({
    name: 'methodId',
  ...
  async updateForUser(
    ...
    return this.paymentMethodsService.updateForUser(
      userId,
      storeSlug,
      methodId,
  ...
  @ApiOperation({
    summary: 'Delete a payment method for the user in the current store',
  })
  @ApiParam({
    name: 'methodId',
